...
<title>Long Text Layout 2 Column</title>
...
<div class="content_block">
 ...
 <div class="top_title">
  <div class="wraper">
   ...
   <ul>
    ...
    <li><a href="#">Long Text Layout</a></li>
    <li>Two Column</li>
   </ul>
  </div>
 </div>
 <!-- /top_title -->
 <div class="wraper">
  <!-- Long Text Layout 2 Column -->
  <div class="long_text_layout long_text_col_2 gallery">
   <ul>
    <li>
     <div class="img bwWrapper"><a href="images/portfolio/portfolio_43.jpg" rel="prettyPhoto[gallery2]"><img src="<?=get_template_directory_uri()?>/images/portfolio/portfolio_43.jpg" width="443" height="263" alt="" /></a></div>
     <div class="desc">
      <h5><a href="single_full.html">Voluptas Sadips Fugiat Un Dolores Amets Vitae Non Cutate</a><span>Graphic Design, Web Design, Branding</span></h5>
      <p>At vero eos et accusamus et iusto odios un  dignissimos ducimus qui blandersi ditiis prasix esentium voluptatum un deleniti atque si corrupti quos dolores erasteit quas molestias excep turi int occaecati cupiditate non providen simils.</p>
     </div>
    </li>
    <li>
     <div class="img bwWrapper"><a href="images/portfolio/portfolio_44.jpg" rel="prettyPhoto[gallery2]"><img src="<?=get_template_directory_uri()?>/images/portfolio/portfolio_44.jpg" width="443" height="263" alt="" /></a></div>
     <div class="desc">
      <h5><a href="single_full.html">Voluptas Sadips Fugiat Un Dolores Amets Vitae Non Cutate</a><span>Graphic Design, Web Design, Branding</span></h5>
      <p>At vero eos et accusamus et iusto odios un  dignissimos ducimus qui blandersi ditiis prasix esentium voluptatum un deleniti atque si corrupti quos dolores erasteit quas molestias excep turi int occaecati cupiditate non providen simils.</p>
     </div>
    ...
    <li>
     <div class="img bwWrapper"><a href="images/portfolio/portfolio_45.jpg" rel="prettyPhoto[gallery2]"><img src="<?=get_template_directory_uri()?>/images/portfolio/portfolio_45.jpg" width="443" height="263" alt="" /></a></div>
     <div class="desc">
      <h5><a href="single_full.html">Voluptas Sadips Fugiat Un Dolores Amets Vitae Non Cutate</a><span>Graphic Design, Web Design, Branding</span></h5>
      <p>At vero eos et accusamus et iusto odios un  dignissimos ducimus qui blandersi ditiis prasix esentium voluptatum un deleniti atque si corrupti quos dolores erasteit quas molestias excep turi int occaecati cupiditate non providen simils.</p>
     </div>
    ...
    <li>
     <div class="img bwWrapper"><a href="images/portfolio/portfolio_46.jpg" rel="prettyPhoto[gallery2]"><img src="<?=get_template_directory_uri()?>/images/portfolio/portfolio_46.jpg" width="443" height="263" alt="" /></a></div>
     <div class="desc">
      <h5><a href="single_full.html">Voluptas Sadips Fugiat Un Dolores Amets Vitae Non Cutate</a><span>Graphic Design, Web Design, Branding</span></h5>
      <p>At vero eos et accusamus et iusto odios un  dignissimos ducimus qui blandersi ditiis prasix esentium voluptatum un deleniti atque si corrupti quos dolores erasteit quas molestias excep turi int occaecati cupiditate non providen simils.</p>
     </div>
    ...
    <li>
     <div class="img bwWrapper"><a href="images/portfolio/portfolio_47.jpg" rel="prettyPhoto[gallery2]"><img src="<?=get_template_directory_uri()?>/images/portfolio/portfolio_47.jpg" width="443" height="263" alt="" /></a></div>
     <div class="desc">
      <h5><a href="single_full.html">Voluptas Sadips Fugiat Un Dolores Amets Vitae Non Cutate</a><span>Graphic Design, Web Design, Branding</span></h5>
      <p>At vero eos et accusamus et iusto odios un  dignissimos ducimus qui blandersi ditiis prasix esentium voluptatum un deleniti atque si corrupti quos dolores erasteit quas molestias excep turi int occaecati cupiditate non providen simils.</p>
     </div>
    ...
    <li>
     <div class="img bwWrapper"><a href="images/portfolio/portfolio_48.jpg" rel="prettyPhoto[gallery2]"><img src="<?=get_template_directory_uri()?>/images/portfolio/portfolio_48.jpg" width="443" height="263" alt="" /></a></div>
     <div class="desc">
      <h5><a href="single_full.html">Voluptas Sadips Fugiat Un Dolores Amets Vitae Non Cutate</a><span>Graphic Design, Web Design, Branding</span></h5>
      <p>At vero eos et accusamus et iusto odios un  dignissimos ducimus qui blandersi ditiis prasix esentium voluptatum un deleniti atque si corrupti quos dolores erasteit quas molestias excep turi int occaecati cupiditate non providen simils.</p>
     </div>
